...
public class HeuristicSimulationPlayerRefactored extends AlphaBetaPlayerFixedRefactored {
	
    private long availableTime=5000;
   

	public HeuristicSimulationPlayerRefactored(GameState2P state, int index, Quoridor game) {
